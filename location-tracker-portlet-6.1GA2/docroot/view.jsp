...
function exportToExcel(url){
	...
	document.getElementById('portletSearchForm').action=url + "&portletId=" + document.getElementById('portletId').value;
	document.getElementById('portletSearchForm').submit();
}
...
<td> Portlet :</td>
<td> 
<select name="portletId" id="portletId">
...
<td><input type="button" value="Find" onclick="javascript:findPortlets()"></input></td>
</tr>
...
<div>
	<input type="button" value="Export To Excel" onclick="javascript:exportToExcel('<%= exportToExcelURL %>')"></input>
</div>
